...
function ccc1():number{
      return 5000;
}
function ccc2():string{
      return "Return"
}
console.log(ccc1());
console.log(ccc2());
...
function ParaAndRe1(num:number):string{
      if(num % 2 ===0){
            return "คู่";
      }else{
            return "คี่";
...
function ParaAndRe2(a:number,b:number):number{
      return a+b;
}
...
const ParaAndRe3=(num:number):string=>{
      if(num % 2 ===0){
            return "คู่";
      }else{
            return "คี่";
...
const ParaAndRe4=(a:number,b:number):number=>{
      return a+b;
}
...
const DefaultPara=(name:string="aaa")=>{
